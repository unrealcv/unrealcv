...
FString FJsonObjectBP::ToString() const
{
    ...
    else if (this->JsonValue.IsValid())
    {
        ...
        case EJson::Null:
            ...
            break;
        case EJson::String:
            Writer->WriteValue(this->JsonValue->AsString());
            break;
        case EJson::Number:
            Writer->WriteValue(this->JsonValue->AsNumber());
            break;
        case EJson::Boolean:
            Writer->WriteValue(this->JsonValue->AsBool());
            break;
        case EJson::Array:
            FJsonSerializer::Serialize(this->JsonValue->AsArray(), Writer);
            break;
        case EJson::Object:
            FJsonSerializer::Serialize(this->JsonValue->AsObject().ToSharedRef(), Writer);
            break;
        default:
            return TEXT("null");
        }
