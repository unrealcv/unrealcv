...
public:
	...
	bool WriteBytes(const FString& LogicalName, const void* SourceData, int64 NumBytes, FUnrealCVSharedMemoryView& OutView, FString& OutError);
...
private:
	...
	bool CreateOrResizeRegion(const FString& LogicalName, int64 NumBytes, FUnrealCVSharedMemoryView& OutView, FString& OutError);
